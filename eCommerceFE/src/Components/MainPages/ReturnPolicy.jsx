    ...
    <>
      ...
      <div className="returnPolicyArticle">
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Items eligible for return must be unused, in their original
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Customers have {numOfDays} days from the date of delivery to
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>To initiate a return, customers must contact our customer service
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Returned items will be inspected upon receipt. Items must be in new,
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Refunds will be processed using the same method as the original
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>A restocking fee may apply to certain returns, especially
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>To protect against fraudulent returns, we reserve the right to deny
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Certain items, as specified in the product description, are
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Customers are responsible for return shipping costs unless the
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>International returns may be subject to additional shipping fees and
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>We reserve the right to modify this return policy at any time.
        ...
        <div className="articleDiv">
          ...
          <br></br>
          <p className='bodyContent'>Our goal is to provide a fair and transparent return process. If you
