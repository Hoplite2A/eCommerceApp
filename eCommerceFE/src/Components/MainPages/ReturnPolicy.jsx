      ...
      <div className="ReturnPolicyArticle">
        <article>
          ...
          <p className="ReturnPolicyBody">
            <h2>Eligibility</h2>
            <br></br>Items eligible for return must be unused, in their original
            ...
            <h2>Return Window</h2>
            <br></br>
            Customers have {numOfDays}] days from the date of delivery to
            initiate a return. After this period, returns may not be accepted.
            <br></br>
            <br></br>
            <h2>Return Process</h2>
            <br></br>
            To initiate a return, customers must contact our customer service
            team through the designated channels provided on our website. A
            return authorization (RA) number will be issued upon approval.
            <br></br>
            <br></br>
            <h2>Condition of Returned Items</h2>
            <br></br>
            Returned items will be inspected upon receipt. Items must be in new,
            unused condition to be eligible for a refund. Any damage or signs of
            use may result in a partial refund or denial of the return.
            <br></br>
            <br></br>
            <h2>Refund Method</h2>
            <br></br>
            ...
            <br></br>A restocking fee may apply to certain returns, especially
            for large or specialized items. This fee will be clearly
            communicated during the return authorization process.
            <br></br>
            <br></br>
            ...
            <h2>Exclusions</h2>
            <br></br>
            Certain items, as specified in the product description, are
            ...
            <br></br>
            Our goal is to provide a fair and transparent return process. If you
            have any concerns or questions regarding our return policy, please
            contact our customer service team. We are here to assist you.
          </p>
        </article>
        <Link to="/">
