...
export default function Cart() {
    ...
    // useEffect(() => {
    //     let newCartItemList = [];
    //     const cartItemList = localStorage.getItem('cart');
    //     console.log(`Local Storage Array ${cartItemList}`);
    //     // let quantity = 1;
    //     cartItemList.forEach(cartItem => {
    //         if (!newCartItemList.includes(cartItem)) {
    //             newCartItemList.push(cartItem)
    //         }
    //     })
    //     console.log(`New Array ${newCartItemList}`);
