            ...
            <div className="regBanner">
                <div className="regBannerMessageAndButton">
                    <div className="message">
                        <p className="regBannerText">Register now and take advantage of our membership's benefits</p>
                    </div>
                ...
                <div className="regBannerClose">
                    <button className="regCloseButton" onClick={closeButton}>
                        <img src="../assets/RegBannerCloseButton" alt="Button to close Registartion Banner" />
                    </button>
                </div>
            </div> :
            null 
